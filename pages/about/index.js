       ...
       gap-x-6'>
        ...
        <div className='flex-1 flex flex-col justify-center'>
          <motion.h2 
            ...
            exit="hidden"
          >
            Captivating <span className='text-accent' >stories</span> magnificent designs. 
          </motion.h2>
          <motion.p 
            ...
            exit="hidden"
          >
            10 years, I began freelancing as a designer. since then,
            I've done remote work for agencies, consolted for startups,
          ...
          >
            <div className='flex flex-1 xl:gap-x-6'>
              ...
              >
                <div className='text-2xl xl:text-4xl font-extrabold text-accent mb-2'>
                  <CountUp start={0} end={59} duration={5} /> +
                </div>
